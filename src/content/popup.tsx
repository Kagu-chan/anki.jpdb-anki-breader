...
export class Popup {
    ...
    static getDemoMode(parent: HTMLElement, cfg: Config): Popup {
    ...
    render() {
        console.log('render', Popup.#popup, this.#demoMode);
        ...
        if (config.blacklistDeck?.length) {
            children.push(
                <button
                    class='blacklist'
                    onclick={
        ...
        if (config.neverForgetDeck?.length) {
            children.push(
                <button
                    class='never-forget'
                    onclick={
                    ...
                    {!neverForget ? 'Never forget' : 'Remove from never forget'}
                </button>,
            );
        }

        this.#mineButtons.replaceChildren(...children);
    }
