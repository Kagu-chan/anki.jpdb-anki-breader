...
(() => {
/*!***********************************!*\
  !*** ./src/apps/jpdb-settings.ts ***!
  \***********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_messaging__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lib/messaging */ "./src/lib/messaging.ts");

(0,_lib_messaging__WEBPACK_IMPORTED_MODULE_0__.registerListener)('copy-api-key', () => {
    return Array.from(document.querySelectorAll('td')).find((node) => node.innerText === 'API key').nextSibling.innerText;
});
...
/******/ })()
;
//# sourceMappingURL=jpdb-settings.js.map