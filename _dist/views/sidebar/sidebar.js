...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TabElement: () => (/* binding */ TabElement)
/* harmony export */ });
/* harmony import */ var _lib_lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lib/lit */ "./src/lib/lit.ts");
...
class TabElement extends _lib_lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    constructor() {
        super();
...
], TabElement.prototype, "_tab", void 0);
...
/* harmony import */ var _components_tab_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @components/tab-element */ "./src/components/tab-element.ts");
...
let SidebarIcon = class SidebarIcon extends _components_tab_element__WEBPACK_IMPORTED_MODULE_1__.TabElement {
    render() {
        var _a, _b;
        return (0,_lib_lit__WEBPACK_IMPORTED_MODULE_2__.when)((_b = (_a = this._tab) === null || _a === void 0 ? void 0 : _a.favIconUrl) === null || _b === void 0 ? void 0 : _b.length, () => (0,_lib_lit__WEBPACK_IMPORTED_MODULE_2__.html) `<img class="icon" src="${this._tab.favIconUrl}" />`, () => (0,_lib_lit__WEBPACK_IMPORTED_MODULE_2__.html) `<md-icon class="icon">abc</md-icon>`);
    }
};
SidebarIcon.styles = [_components_component_styles__WEBPACK_IMPORTED_MODULE_0__.componentStyles];
SidebarIcon = __decorate([
    (0,_lib_lit__WEBPACK_IMPORTED_MODULE_2__.customElement)('sidebar-icon')
], SidebarIcon);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SidebarTabMenu: () => (/* binding */ SidebarTabMenu)
/* harmony export */ });
/* harmony import */ var _components_component_styles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @components/component-styles */ "./src/components/component-styles.ts");
...
let SidebarTabMenu = class SidebarTabMenu extends _components_tabs_element__WEBPACK_IMPORTED_MODULE_1__.TabsElement {
    render() {
        return (0,_lib_lit__WEBPACK_IMPORTED_MODULE_2__.html) `
      <md-icon-button
        id="tab-menu-button"
        @click="${() => (this._menu.open = !this._menu.open)}"
...
SidebarTabMenu.styles = [_components_component_styles__WEBPACK_IMPORTED_MODULE_0__.componentStyles];
__decorate([
    (0,_lib_lit__WEBPACK_IMPORTED_MODULE_2__.query)('#tab-menu-menu')
], SidebarTabMenu.prototype, "_menu", void 0);
SidebarTabMenu = __decorate([
    (0,_lib_lit__WEBPACK_IMPORTED_MODULE_2__.customElement)('sidebar-tab-menu')
], SidebarTabMenu);
...
/* harmony export */ });
/* harmony import */ var _components_tab_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @components/tab-element */ "./src/components/tab-element.ts");
...
let SidebarTitle = class SidebarTitle extends _components_tab_element__WEBPACK_IMPORTED_MODULE_0__.TabElement {
    render() {
        var _a;
        return (0,_lib_lit__WEBPACK_IMPORTED_MODULE_1__.html) `<h3 class="title">${(_a = this._tab) === null || _a === void 0 ? void 0 : _a.title}</h3>`;
    }
};
SidebarTitle = __decorate([
    (0,_lib_lit__WEBPACK_IMPORTED_MODULE_1__.customElement)('sidebar-title')
], SidebarTitle);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MenuItemController: () => (/* binding */ MenuItemController)
/* harmony export */ });
/* harmony import */ var _shared_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared.js */ "./node_modules/@material/web/menu/internal/controllers/shared.js");
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
    ...
    constructor(host, config) {
        ...
        this.onClick = () => {
            if (this.host.keepOpen)
                return;
            this.host.dispatchEvent((0,_shared_js__WEBPACK_IMPORTED_MODULE_0__.createDefaultCloseMenuEvent)(this.host, {
                kind: _shared_js__WEBPACK_IMPORTED_MODULE_0__.CloseReason.CLICK_SELECTION,
            }));
        };
        /**
         * Bind this click listener to the interactive element. Handles closing the
        ...
        this.onKeydown = (event) => {
            ...
            if (this.host.keepOpen && keyCode !== 'Escape')
                return;
            if ((0,_shared_js__WEBPACK_IMPORTED_MODULE_0__.isClosableKey)(keyCode)) {
                event.preventDefault();
                this.host.dispatchEvent((0,_shared_js__WEBPACK_IMPORTED_MODULE_0__.createDefaultCloseMenuEvent)(this.host, {
                    kind: _shared_js__WEBPACK_IMPORTED_MODULE_0__.CloseReason.KEYDOWN,
                    key: keyCode,
                }));
            }
        };
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MenuItemEl: () => (/* binding */ MenuItemEl)
/* harmony export */ });
...
/* harmony import */ var _controllers_menuItemController_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../controllers/menuItemController.js */ "./node_modules/@material/web/menu/internal/controllers/menuItemController.js");
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 */
class MenuItemEl extends lit__WEBPACK_IMPORTED_MODULE_3__.LitElement {
    constructor() {
        super(...arguments);
        /**
         ...
         */
        this.selected = false;
        this.menuItemController = new _controllers_menuItemController_js__WEBPACK_IMPORTED_MODULE_8__.MenuItemController(this, {
            getHeadlineElements: () => {
    ...
    renderListItem(content) {
      ...
      <${tag}
        ...
        aria-label=${this.ariaLabel || lit__WEBPACK_IMPORTED_MODULE_3__.nothing}
...
(() => {
    (0,_internal_aria_delegate_js__WEBPACK_IMPORTED_MODULE_7__.requestUpdateOnAriaChange)(MenuItemEl);
})();
/** @nocollapse */
...
(0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_4__.property)({ type: Boolean, attribute: 'keep-open' })
...
(0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_4__.queryAssignedElements)({ slot: 'headline' })
], MenuItemEl.prototype, "headlineElements", void 0);
(0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_4__.queryAssignedElements)({ slot: 'supporting-text' })
], MenuItemEl.prototype, "supportingTextElements", void 0);
(0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_4__.queryAssignedNodes)({ slot: '' })
], MenuItemEl.prototype, "defaultElements", void 0);
(0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_4__.property)({ attribute: 'typeahead-text' })
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MdMenuItem: () => (/* binding */ MdMenuItem)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.mjs");
/* harmony import */ var lit_decorators_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit/decorators.js */ "./node_modules/lit/decorators.js");
/* harmony import */ var _internal_menuitem_menu_item_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./internal/menuitem/menu-item.js */ "./node_modules/@material/web/menu/internal/menuitem/menu-item.js");
/* harmony import */ var _internal_menuitem_menu_item_styles_css_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./internal/menuitem/menu-item-styles.css.js */ "./node_modules/@material/web/menu/internal/menuitem/menu-item-styles.css.js");
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * @suppress {visibility}
 */
let MdMenuItem = class MdMenuItem extends _internal_menuitem_menu_item_js__WEBPACK_IMPORTED_MODULE_1__.MenuItemEl {
};
MdMenuItem.styles = [_internal_menuitem_menu_item_styles_css_js__WEBPACK_IMPORTED_MODULE_2__.styles];
MdMenuItem = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_0__.customElement)('md-menu-item')
], MdMenuItem);
//# sourceMappingURL=menu-item.js.map
...
/* harmony import */ var _internal_menu_styles_css_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./internal/menu-styles.css.js */ "./node_modules/@material/web/menu/internal/menu-styles.css.js");
...
MdMenu.styles = [_internal_menu_styles_css_js__WEBPACK_IMPORTED_MODULE_2__.styles];
...
/* harmony import */ var _components_component_styles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @components/component-styles */ "./src/components/component-styles.ts");
/* harmony import */ var _lib_lit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @lib/lit */ "./src/lib/lit.ts");
/* harmony import */ var _material_web_icon_icon_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @material/web/icon/icon.js */ "./node_modules/@material/web/icon/icon.js");
/* harmony import */ var _material_web_iconbutton_icon_button_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @material/web/iconbutton/icon-button.js */ "./node_modules/@material/web/iconbutton/icon-button.js");
...
/* harmony import */ var _components_settings_button__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @components/settings-button */ "./src/components/settings-button.ts");
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./icon */ "./src/views/sidebar/icon.ts");
/* harmony import */ var _tab_menu__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tab-menu */ "./src/views/sidebar/tab-menu.ts");
/* harmony import */ var _title__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./title */ "./src/views/sidebar/title.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let SidebarView = class SidebarView extends _lib_lit__WEBPACK_IMPORTED_MODULE_1__.LitElement {
    render() {
...
SidebarView.styles = [_components_component_styles__WEBPACK_IMPORTED_MODULE_0__.componentStyles];
SidebarView = __decorate([
    (0,_lib_lit__WEBPACK_IMPORTED_MODULE_1__.customElement)('sidebar-view')
], SidebarView);
